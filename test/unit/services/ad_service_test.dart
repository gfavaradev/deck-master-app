...
/// Copre la sincronizzazione fra inizializzazione di AdMob e caricamento dei
/// rewarded ad. `main()` ritarda l'init di qualche secondo per non rubare frame
/// all'intro, mentre la home avvia il preload appena viene montata: senza
/// un'attesa esplicita il load può partire a SDK non ancora pronto e fallisce
/// sempre, mostrando all'utente "Video non disponibile".
void main() {
