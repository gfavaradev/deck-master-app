...
class _ProPageState extends State<ProPage> with SingleTickerProviderStateMixin {
      ...
      children: [
        SizedBox(
          ...
          child: FilledButton.icon(
            ...
            label: Text(
              _annual
                  ? 'Prova Gratis 7 giorni — poi €${_annualPrice.toStringAsFixed(2)}/anno'
                  : 'Inizia a €${_monthlyPrice.toStringAsFixed(2)}/mese',
  ...
  void _onUpgradeTap() {
    // TODO: integrare RevenueCat / in_app_purchase quando si pubblica sugli store
    showDialog(
      context: context,
      builder: (ctx) => AlertDialog(
        ...
        content: const Text(
          'Gli abbonamenti in-app saranno disponibili al lancio ufficiale sugli store.\n\n'
          'Se vuoi accedere a Pro in anteprima, contatta lo sviluppatore.',
          style: TextStyle(color: AppColors.textSecondary),
        ),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(ctx),
            child: const Text('Chiudi', style: TextStyle(color: AppColors.gold)),
          ),
        ],
      ),
    );
